...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    projectFiles: "Browse workspace files. Upload/delete only in project.",
    ...
    team: "Add or remove gateway agents (workspaces and sessions).",
  ...
  projectFiles: {
    title: "Project files",
    lead: "Browse your workspace. Upload and delete are limited to the project folder.",
    workspace: "Workspace",
    ...
    uploadHint: "Uploads are allowed only in the project folder (files and folders).",
    readonlyHint: "Read-only outside project folder.",
    uploading: "Uploading...",
  ...
  agentsTeam: {
    tab: "Team",
    addTitle: "Add workspace agent",
    addSubtitle:
      "Creates an isolated agent with its own workspace, agent directory, and sessions on this gateway. Configure channel bindings separately (see multi-agent docs).",
    displayName: "Display name",
    displayNamePlaceholder: "e.g. Alice",
    displayNameHint: "Used as the agent id when it matches id rules; otherwise it is normalized.",
    workspacePath: "Workspace directory",
    workspacePlaceholder: "e.g. ~/.openclaw/workspace-alice",
    workspaceHint: "Absolute path or ~ home path on the gateway host.",
    modelOptional: "Default model (optional)",
    modelPlaceholder: "e.g. anthropic/claude-opus-4-6",
    addAgent: "Add agent",
    listTitle: "Agents on this gateway",
    listSubtitle: "Each row is one agent brain; routing to channels uses bindings in config.",
    empty: "No agents returned yet.",
    colAgent: "Agent",
