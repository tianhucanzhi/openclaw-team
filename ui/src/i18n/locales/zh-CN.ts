...
export const zh_CN: TranslationMap = {
  common: {
    ...
    version: "版本",
    enterprisePortalVersion: "企业版-{account}",
    enterprisePortalOnly: "企业版",
    docs: "文档",
    theme: "主题",
    resources: "资源",
    search: "搜索",
  ...
  subtitles: {
    ...
    usage: "API 使用情况和成本。",
    cron: "唤醒和重复运行。",
    projectFiles: "查看工作区文件；仅 project 目录允许上传和删除。",
    skills: "技能和 API 密钥。",
    nodes: "配对设备和命令。",
    chat: "网关聊天，快速干预。",
  ...
  projectFiles: {
    title: "项目文件管理",
    lead: "浏览工作区文件；上传与删除仅限 project 目录。",
    workspace: "工作区",
    currentPath: "当前路径",
    goUp: "返回上级",
    root: "工作区根目录",
    projectRoot: "project 目录",
    loading: "正在加载文件...",
    uploadHint: "仅允许在 project 目录内上传文件或文件夹。",
    readonlyHint: "当前目录只读（project 目录外）。",
    uploading: "上传中...",
    selectFile: "选择文件",
    selectFolder: "选择文件夹",
    emptyFolder: "此文件夹为空。",
